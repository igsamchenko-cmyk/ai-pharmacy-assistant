...
export const interactionRules: InteractionRule[] = [
  ...
  },
  {
    ...
    whatToCheck: "Уточніть, чи комбінацію призначив лікар, контроль МНО, ознаки кровотеч.",
    whenToSeeDoctor: "При будь-яких ознаках кровотечі звертатися по медичну допомогу негайно.",
  },
  {
    a: "варфарин",
    b: "диклофенак",
  ...
  },
  {
    ...
    riskLevel: "high",
    explanation:
      "НПЗЗ можуть посилювати дію варфарину та ризик кровотеч.",
  ...
  },
  {
    ...
    whatToCheck: "Перевірте, чи потрібні обидва засоби, рознесення прийому в часі, захист ШКТ.",
    whenToSeeDoctor: "При болю в животі, чорному калі або блюванні з кров'ю — до лікаря.",
  },
  {
    a: "ібупрофен",
    b: "диклофенак",
  ...
  },
  {
    ...
    b: "німесулід",
    riskLevel: "high",
    explanation: "Два НПЗЗ разом підвищують ризик ускладнень з боку ШКТ та нирок.",
  ...
  },
  {
    ...
    whatToCheck: "Контроль артеріального тиску та функції нирок, тривалість прийому НПЗЗ.",
    whenToSeeDoctor: "При набряках, зменшенні сечовиділення чи неконтрольованому тиску — до лікаря.",
  },
  {
    a: "диклофенак",
    b: "еналаприл",
  ...
  },
  {
    ...
    whatToCheck: "Для низьких кардіопротекторних доз ризик зазвичай незначний; контроль тиску.",
  ...
  },
  {
    ...
    whenToSeeDoctor: "При вираженій сонливості — переглянути терапію з лікарем.",
  },
  {
    a: "корвалол",
    b: "цетиризин",
  ...
  },
  {
    ...
    whenToSeeDoctor: "При симптомах гіпоглікемії — проконсультуватися з лікарем.",
  },
];
