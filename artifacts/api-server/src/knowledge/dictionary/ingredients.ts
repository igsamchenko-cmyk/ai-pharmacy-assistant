...
export const ingredientSeeds: IngredientSeed[] = [
  ...
  // ── Antibiotics ─────────────────────────────────────────────────────────
  { inn: "Амоксицилін", latin: "Amoxicillinum", english: "Amoxicillin", atc: "J01CA04", group: "Пеніциліни", brands: ["Амоксил", "Оспамокс", "Флемоксин Солютаб", "Hiconcil"] },
  { inn: "Амоксицилін + клавуланова кислота", latin: "Amoxicillinum + Acidum clavulanicum", english: "Amoxicillin + clavulanic acid", atc: "J01CR02", group: "Захищені пеніциліни", brands: ["Аугментин", "Augmentin", "Амоксиклав", "Amoksiklav", "Флемоклав"] },
  ...
  { inn: "Цефтріаксон", latin: "Ceftriaxonum", english: "Ceftriaxone", atc: "J01DD04", group: "Цефалоспорини III", brands: ["Роцефін", "Медаксон", "Лораксон"] },
  ...
  // ── Gastro ──────────────────────────────────────────────────────────────
  { inn: "Омепразол", latin: "Omeprazolum", english: "Omeprazole", atc: "A02BC01", group: "Інгібітори протонної помпи", brands: ["Омез", "Omez", "Гастрозол", "Лосек"] },
  { inn: "Пантопразол", latin: "Pantoprazolum", english: "Pantoprazole", atc: "A02BC02", group: "Інгібітори протонної помпи", brands: ["Контролок", "Нольпаза", "Пантасан"] },
  ...
  { inn: "Дротаверин", latin: "Drotaverinum", english: "Drotaverine", atc: "A03AD02", group: "Спазмолітики", brands: ["Но-шпа", "No-Spa", "Дротаверин"] },
  ...
  { inn: "Лоратадин", latin: "Loratadinum", english: "Loratadine", atc: "R06AX13", group: "Антигістамінні II покоління", brands: ["Кларитин", "Claritin", "Лорано"] },
  { inn: "Цетиризин", latin: "Cetirizinum", english: "Cetirizine", atc: "R06AE07", group: "Антигістамінні II покоління", brands: ["Цетрин", "Zyrtec", "Зіртек", "Аллертек"] },
  ...
  { inn: "Амлодипін", latin: "Amlodipinum", english: "Amlodipine", atc: "C08CA01", group: "Блокатори кальцієвих каналів", brands: ["Норваск", "Амлодак", "Аген"] },
  ...
  { inn: "Фуросемід", latin: "Furosemidum", english: "Furosemide", atc: "C03CA01", group: "Петльові діуретики", brands: ["Лазикс", "Lasix"] },
  { inn: "Торасемід", latin: "Torasemidum", english: "Torasemide", atc: "C03CA04", group: "Петльові діуретики", brands: ["Торсид", "Тригрим"] },
  ...
  { inn: "Ривароксабан", latin: "Rivaroxabanum", english: "Rivaroxaban", atc: "B01AF01", group: "Прямі оральні антикоагулянти", brands: ["Ксарелто", "Xarelto"] },
  { inn: "Апіксабан", latin: "Apixabanum", english: "Apixaban", atc: "B01AF02", group: "Прямі оральні антикоагулянти", brands: ["Еліквіс", "Eliquis"] },
  ...
  // ── Diabetes / endocrine ────────────────────────────────────────────────
  { inn: "Метформін", latin: "Metforminum", english: "Metformin", atc: "A10BA02", group: "Бігуаніди", brands: ["Сіофор", "Siofor", "Глюкофаж", "Метфогама"] },
  ...
  // ── Steroids / hormones ─────────────────────────────────────────────────
  { inn: "Преднізолон", latin: "Prednisolonum", english: "Prednisolone", atc: "H02AB06", group: "Глюкокортикоїди", brands: ["Преднізолон"] },
  { inn: "Дексаметазон", latin: "Dexamethasonum", english: "Dexamethasone", atc: "H02AB02", group: "Глюкокортикоїди", brands: ["Дексаметазон", "Дексазон"] },
