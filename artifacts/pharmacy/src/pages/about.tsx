  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-10">
      <div className="space-y-1 text-center py-6">
        ...
        <p className="text-muted-foreground">Інформаційний помічник фармацевта</p>
      </div>
      ...
      <div className="grid gap-4 mt-6">
        <Card className="border-l-4 border-l-primary bg-card/50">
          <CardContent className="p-5 flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-foreground text-lg mb-1">Що робить застосунок?</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Допомагає швидко знаходити інформацію про препарати, їх аналоги та можливі взаємодії. Штучний інтелект структурує складні інструкції у зручний формат для швидкого читання за першим столом.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-destructive bg-card/50">
          <CardContent className="p-5 flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-foreground text-lg mb-1">Чого застосунок НЕ робить?</h3>
        ...
        <Card className="border-l-4 border-l-accent bg-card/50">
          <CardContent className="p-5 flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-foreground text-lg mb-1">Дані та безпека</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Наразі система працює на <span className="font-bold text-foreground bg-accent/30 px-1 rounded">{DEMO_LABEL}</span>. Всі препарати вигадані, а інформація згенерована для демонстрації можливостей платформи.
              </p>
            </div>
          </CardContent>
        </Card>
