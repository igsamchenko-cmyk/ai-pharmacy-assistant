...
Vitest (`src/services/__tests__`, `src/lib/__tests__`) перевіряє пошук, виявлення
препаратів у тексті, аналоги, взаємодії, шар безпеки та утиліти. Тести працюють над
статичними даними, тож не потребують БД чи мережі.
